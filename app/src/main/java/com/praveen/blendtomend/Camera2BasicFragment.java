/**
 * Modified by Praveen on 13/7/2020.
 */
...
import com.praveen.blendtomend.commonutility.GPSTracker;
import com.praveen.blendtomend.commonutility.OnDisplayOverlay;
import com.praveen.blendtomend.commonutility.OnScreenGUI;
import com.praveen.blendtomend.recentcaptureutility.CustomGalleryActivity;
...
import static com.praveen.blendtomend.commonutility.OnDisplayOverlay.setAvailableStorage;
import static com.praveen.blendtomend.commonutility.OnDisplayOverlay.setCurrentTime;
import static com.praveen.blendtomend.getstoragepath.storagePath.searchRecentCapturingPaths;
                                ...
                                if(count==maxSnap[0]){
                                    ...
                                    if (SettingUtility.getControlSettings(getContext()).getPreviewMode()){
                                        ...
                                        if (!res .equals("")) {
                                            ...
                                            if (SettingUtility.getControlSettings(activity.getApplicationContext()).getProcessingMode().equals("0")){
                                                ...
                                                startActivity(intent);
                                            }else if (SettingUtility.getControlSettings(activity.getApplicationContext()).getProcessingMode().equals("2")){
                                                PostProcessing.manualProcessingMode(getActivity(),res);
                                            }
                                        }
                                    }
                                }
